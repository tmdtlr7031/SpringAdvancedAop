...
public class ParameterTest {
    ...
    static class ParameterAspect {
        ...
        public Object logArg2(ProceedingJoinPoint joinPoint, Object arg) throws Throwable {
            Object arg2 = joinPoint.getArgs()[0];
            log.info("[logArg2]{}, arg={}", joinPoint.getSignature(), arg2);
            return joinPoint.proceed();
        }

        @Before("allMember() && args(arg, ..)")
        public void logArg3(String arg) { // 타입 매칭이 안되면 실행 안됨.
            log.info("[logArg3] arg={}", arg);
        }

        @Before("allMember() && this(obj)")
        public void thisArgs(JoinPoint joinPoint, MemberService obj) {
            log.info("[this]{}, obj = {}", joinPoint.getSignature(), obj.getClass()); // obj는 프록시 객체
        }

        @Before("allMember() && target(obj)")
        public void targetArgs(JoinPoint joinPoint, MemberService obj) {
            log.info("[target]{}, obj = {}", joinPoint.getSignature(), obj.getClass()); // obj는 실제 객체 인스턴스
        }
